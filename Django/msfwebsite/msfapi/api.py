...
if __name__ == "__main__":
    auth = Client("127.0.0.1",'55553',"msf","msf")

    print(auth.get_version())
    print(auth.list_consoles())
    print(auth.create_console())
    id=auth.create_console().get(b'id').decode()
    print(auth.read_console(id))
    print(auth.write_console(id,"search ms17"))
    print(auth.read_console(id))
    print(auth.destroy_console(id))
